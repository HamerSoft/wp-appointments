...
/**
 * Email to customer: reschedule confirmed.
 *
 * @var array<string, mixed>      $booking
 * @var array<string, mixed>|null $service
 * @var string                    $site_name
 * @var string                    $reschedule_link  Fresh link for the next reschedule (Step 7).
 */
?>
<p><?php
printf(
...
<p><?php esc_html_e( 'Your booking has been rescheduled. Here are your updated appointment details:', 'wp-appointments' ); ?></p>
...
<table cellpadding="0" cellspacing="0" border="0"
	...
	<tr>
		<td style="padding:10px 16px;font-weight:bold;border-bottom:1px solid #e0e0e0;">
			<?php esc_html_e( 'New Date', 'wp-appointments' ); ?>
		</td>
		<td style="padding:10px 16px;border-bottom:1px solid #e0e0e0;">
	...
	<tr style="background:#f9f9f9;">
		<td style="padding:10px 16px;font-weight:bold;">
			<?php esc_html_e( 'New Time', 'wp-appointments' ); ?>
		</td>
...
<p style="margin-top:24px;padding:16px;background:#f9f9f9;border-left:4px solid #2c3e50;border-radius:2px;font-size:13px;">
	<?php esc_html_e( 'Need to change the time again?', 'wp-appointments' ); ?>
